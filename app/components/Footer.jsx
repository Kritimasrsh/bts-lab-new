...
const COLUMNS = [
  ...
  },
  {
    title: "Buyback",
    links: [
      { href: "/buyback", label: "Sell your phone" },
      { href: "/buyback", label: "Trade-in" },
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/about", label: "About Mobizilla" },
      ...
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <Link href="/" className="flex items-center gap-2.5">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl brand-gradient font-display text-lg font-extrabold text-paper">
                M
              </span>
              <span className="font-display text-lg font-extrabold tracking-tight">
                MOBI<span className="text-mint">ZILLA</span>
              </span>
            </Link>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-paper/15 pt-6 sm:flex-row sm:items-center">
          <p className="font-mono-tag text-xs text-paper/50">
            © {new Date().getFullYear()} Mobizilla. All rights reserved.
          </p>
