...
const STATS = [
  { value: "1000+", label: "Devices Repaired", icon: DeviceIcon, fg: "text-coral" },
  { value: "98%", label: "Success Rate", icon: CheckCircleIcon, fg: "text-coral" },
  { value: "24hr", label: "Average TAT", icon: ClockIcon, fg: "text-coral" },
  { value: "2000+", label: "Happy Customers", icon: UsersIcon, fg: "text-coral" },
];
