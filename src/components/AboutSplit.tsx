      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          ...
          <div>
            ...
            >
              We&apos;re one of the few labs that do proper board-level repair on any device. We
              don&apos;t just swap parts. We find the real fault and fix it right the first time,
              across every major brand, with a 90%+ success rate on the boards we take on.
            </ScrollReveal>
