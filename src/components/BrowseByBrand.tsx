        ...
        <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7">
          {BRANDS.map((brand) => (
            <Link
              ...
              className="hover-lift focus-ring group flex flex-col items-center gap-3 rounded-2xl border border-ink/8 bg-paper px-4 py-5 transition-colors hover:border-brand/40 hover:bg-brand/5"
            >
