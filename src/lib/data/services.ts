...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    desc: "Ultrasonic cleaning and board-level corrosion treatment. We've saved plenty of phones others called dead.",
    price: "Rs 3,999",
    code: "TKT-03",
    accent: "mint",
  },
...
export const SHOWCASE_SERVICES: ShowcaseService[] = [
  {
    ...
    desc: "OLED, AMOLED and LCD replacement with full touch calibration, and True Tone kept where we can, so your display looks and feels like it did new.",
  ...
  },
  {
    ...
    desc: "Chip-level diagnostics and micro-soldering for the faults most shops won't touch, all under a microscope by trained board engineers.",
  ...
  },
  {
    ...
    desc: "Ultrasonic cleaning and board-level corrosion treatment. The sooner it reaches us, the more we can save, and we've brought back phones that were written off.",
  ...
  },
  {
    ...
    desc: "From silent speakers and distorted mics to bent housings, dead buttons and back-glass replacement, the everyday fixes that make a phone feel whole again.",
